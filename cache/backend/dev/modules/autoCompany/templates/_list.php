    ...
    <table cellspacing="0">
      <thead>
        <tr>
          ...
          <?php include_partial('company/list_th_tabular', array('sort' => $sort)) ?>
        ...
        <tr>
          <th colspan="5">
            <?php if ($pager->haveToPaginate()): ?>
              <?php include_partial('company/pagination', array('pager' => $pager)) ?>
            <?php endif; ?>
      ...
      <tbody>
        <?php foreach ($pager->getResults() as $i => $company): $odd = fmod(++$i, 2) ? 'odd' : 'even' ?>
          <tr class="sf_admin_row <?php echo $odd ?>">
            ...
            <?php include_partial('company/list_td_tabular', array('company' => $company)) ?>
